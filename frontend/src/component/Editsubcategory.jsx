...
function EditSubCategory() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Subcategory updated successfully!', { position: 'top-right', autoClose: 5000 });
      navigate('/contains/subcategory');
    } catch (error) {
      toast.error('Failed to update subcategory.', { position: 'top-right', autoClose: 5000 });
    } finally {
    ...
    <div className="flex h-[580px] pl-[220px] mt-[50px] pt-4">
      <div className="w-[1250px] h-[550px] bg-white p-4">
        <div className="flex items-center gap-2 p-2">
          ...
          <h1 className="text-xl font-bold">Edit Subcategory</h1>
        </div>
        ...
        <div className="absolute right-[50px] bottom-[70px]">
          ...
          <button
            onClick={() => navigate('/contains/subcategory')}
